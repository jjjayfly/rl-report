...
\thesistitle{CityU Car Survives Through Hong Kong} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Dr. Clint Chin Pang \textsc{HO}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\subject{SDSC6007 Dynamic Programming and Reinforcement Learning} % Your subject area, this is not currently used anywhere in the template, print it elsewhere with \subjectname
...
\textsc{\Large Course Project Report}\\[0.5cm] % Thesis type
...
\emph{Supervisor:} \\
\href{http://www.cityu.edu.hk/stfprofile/ClintHo.htm}{\supname} % Supervisor name - remove the \href bracket to remove the link  
\end{flushright}
\end{minipage}\\[3cm]
